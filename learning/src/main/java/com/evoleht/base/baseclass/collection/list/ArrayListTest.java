        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * The array buffer into which the elements of the ArrayListTest are stored.
     * The capacity of the ArrayListTest is the length of this array buffer.
     */
    private transient Object[] elementData;

    /**
     * The size of the ArrayListTest (the number of elements it contains).
     *
     * @serial
     */
    private int size;
    ...
    public Object clone() {
	try {
	    ArrayListTest<E> v = (ArrayListTest<E>) super.clone();
