      ...
      static { 
        ...
        public class SortSet {
            ...
            public double incrByFloat(String key, double number) {
            	Jedis jedis = getJedis();
            	Double len = jedis.incrByFloat(key, number);
            	returnJedis(jedis);
                return len==null?0:len;
    		}
            ...
            public long zrevrank(String key, String member) {
                //ShardedJedis sjedis = getShardedJedis();
                Jedis sjedis = getJedis(); 
                Long index = sjedis.zrevrank(key, member)==null?-1l:sjedis.zrevrank(key, member)+1l;
                returnJedis(sjedis);
            ...
            public long zrem(String key, String member) {
                Jedis jedis = getJedis();
                long s = jedis.zrem(key, member)==null?0:jedis.zrem(key, member);
                returnJedis(jedis);
                return s;
            }
            ...
            public long zrem(String key) {
                Jedis jedis = getJedis();
                long s = jedis.del(key)==null?0:jedis.del(key);
                returnJedis(jedis);
                return s;
            }
            ...
            public long zremrangeByRank(String key, int start, int end) {
                Jedis jedis = getJedis();
                long s = jedis.zremrangeByRank(key, start, end)==null?0:jedis.zremrangeByRank(key, start, end);
                returnJedis(jedis);
                return s;
            }
        ...
        public class Hash {
            ...
            public long hincrby(String key, String fieid, long value) {
                Jedis jedis = getJedis();
                Long s = jedis.hincrBy(key, fieid, value)==null?0:jedis.hincrBy(key, fieid, value);
                returnJedis(jedis);
                return s==null?0:s;
            }
            ...
            public long hlen(String key) {
                //ShardedJedis sjedis = getShardedJedis();
                Jedis sjedis = getJedis();  
                long len = sjedis.hlen(key)==null?0:sjedis.hlen(key);
                returnJedis(sjedis);
                return len;
            }
